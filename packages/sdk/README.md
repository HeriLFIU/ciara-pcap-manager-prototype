...
```python
from ciara_pcap_sdk import AuthenticatedClient
...
```python
from ciara_pcap_sdk.models import MyDataModel
from ciara_pcap_sdk.api.my_tag import get_my_data_model
from ciara_pcap_sdk.types import Response
...
1. Any endpoint which did not have a tag will be in `ciara_pcap_sdk.api.default`
